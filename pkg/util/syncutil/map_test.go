...
func TestMapLen(t *testing.T) {
	...
	// Overwrite existing key shouldn't change length
	val1b := int64(10)
	m.Store(1, &val1b)
	require.Equal(t, 3, m.Len())
	...
	require.Equal(t, numGoroutines*numOps, m.Len())
	...
	// Should have half the entries
	require.Equal(t, (numGoroutines-numGoroutines/2)*numOps, m.Len())
}
